<?php
/**
 * This file adds the Category Index to the Novelty Theme.
 *
 * @package      Novelty
...
add_action( 'genesis_meta', 'novelty_category_genesis_meta' );
/**
 * Add widget support for category index. If no widgets active, display the default loop.
 *
 */
function novelty_category_genesis_meta() {

	if ( is_active_sidebar( 'category-index' )) {

		remove_action( 'genesis_loop', 'genesis_do_loop' );
		add_action( 'genesis_loop', 'novelty_category_sections' );
...
function novelty_category_sections() {
